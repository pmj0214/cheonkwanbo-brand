...
<head>
	...
	<script type="text/javascript">
		$(function(){
			$('.btn-save').click(function(){
				...
				var data = {
					'code':"DEFAULT",'url':"CHEONKWANBO",'device':"PC"
		...
		$('html').mousewheel(function(e){
			var top = parseInt($('html, body').scrollTop());
			$('.page[no]').each(function(){
				var n = parseInt($(this).attr('no'));
				var t = parseInt($(this).offset().top)-220;
				var h = parseInt($(this).height());
				var nt = parseInt($('.page[no='+n+']').offset().top)-220;
				console.log(t, h, top,n);
				if(t <= top && t+h > top){
					$('.nav .item.active').removeClass('active');
					$('.fixedNav .item').css({'border-color':'#99a49e'})
					if($('.nav .item[no="'+n+'"]').length > 0) $('.nav .item[no="'+n+'"]').addClass('active');

					if( n == 8 && t+(h-390) > top ) {
						$('.fixedNav .item').css({'border-color':'white'});

					}
					if( n > 7) {$('.fixed.goto').fadeOut(150)} else {$('.fixed.goto').fadeIn(150)}

					$('.fixedNav .item.active').removeClass('active');
					if($('.fixedNav .item[no="'+n+'"]').length > 0) $('.fixedNav .item[no="'+n+'"]').addClass('active');
					return false;
				}
			});
	...
	<style>
		.head {height: 62px; background-image: linear-gradient(to right, #722d39,#64313b)}
		.head .in {height: 214px;}
		.head .in div {position: relative;}
		.head .l1 {height: 62px; width: 310px; background-color: #722d39;}
		.head .l2 {width: 1000px; max-height: 214px;}
		.head .l3 {height: 62px; width: 310px; background-color: #64313b; cursor: pointer;}
		.head .l1 img {position: absolute; top: 50%; left: 0; transform: translate(0,-50%); height: 100%;}
		.head .l3 img {position: absolute; top: 50%; left: 0; transform: translate(0,-50%); height: 100%}

		.page,.page .in {max-width: 1000px; margin: 0 auto; }
		.page img {width: 100%;}
		#page1 {padding-top: 60px;}
		/* #pagedb .apply {width: 800px; top: 265px; transform: translateX(-52.5%);} */


		#page9 {background-color: #3c1d19; width: 100%; max-width: none;}
		#page9 .slide {position: absolute; z-index: 2; left: 50%; top: 177px; transform: translateX(-50%); width: 943px; overflow: hidden; }
		...
		.page .al {left: 50px; width: 39px;}
		.page .ar {right: 50px; width: 39px;}
...
<body>
	...
	<div class="fixed goto" no="pagedb">
		<a href="#pagedb"><img src="/pc/images/banner_01.png" alt="1877-1478 빠른주문상담가기"></a>
	</div>
	<div class="head">
		<div class="in">
			<div class="l1"><img src="/pc/images/head1-2.png"></div>
			<div class="l2"><a href="#page1"><img src="/pc/images/head1-1_191126.png"></a></div>
			<div class="l3"><a href="#pagedb"><img src="/pc/images/head1-3_191119.png"></a></div>
		</div>
	</div>
	<div class="page" id="page1" no="1">&nbsp;</div>
	<div class="page">
		<div class="in"><img src="/pc/images/page1_191119.jpg"></div>
	</div>
	<div class="page" id="page2" no="2" style="background-color: #3c1d19; max-width: none;">
		<div class="in">
			<img src="/pc/images/page2_191119.jpg">
		</div>
	</div>
	<div class="page" id="page3" no="3">
		<div class="in"><img src="/pc/images/page3_191119.jpg"></div>
	</div>
	<div class="page" id="page4" no="4" style="">
		<div class="in"><img src="/pc/images/page4_191119.jpg"></div>
	</div>
	<div class="page" id="page5" no="5">
		<div class="in"><img src="/pc/images/page5_191119.jpg"></div>
	</div>
	<div class="page" id="page6" no="6" style="background-image: linear-gradient(#fff, #dfddea); max-width: none;">
		<div class="in"><img src="/pc/images/page6_191119.jpg"></div>
	</div>
	<div class="page" id="page7" no="7">
		<div class="in"><img src="/pc/images/page7_191119.jpg"></div>
	</div>
	<div class="page" id="page8" no="8" style="background-image: linear-gradient(to right, #d5c9df , #eeebf5); max-width: none;">
		<div class="in"><img src="/pc/images/page8_191119.jpg"></div>
	</div>
	<!-- div class="page" id="page9" style="background-color: #3c1d19; max-width: none;">
		<div class="in">
			<img src="/pc/images/page9_191119.jpg"/>
		</div>
	</div -->
	<div class="page" id="page9" no="9">
		<div class="in">
			<img src="/pc/images/page9_191126.png">

			<div class="slide" no="0">
				<div class="slide-in">
					<div class="item"><img src="/pc/images/page9-1_191126.png"></div>
					<div class="item"><img src="/pc/images/page9-2_191126.png"></div>
					<div class="item"><img src="/pc/images/page9-3_191126.png"></div>
				</div>
			</div>

			<div class="al"><img src="/pc/images/page9-al.png"></div>
			<div class="ar"><img src="/pc/images/page9-ar.png"></div>
		</div>
	</div>
	<div class="page" id="pagedb" style="background-color: #832532; max-width: none;">
		<div class="in" style="max-width: none;">
			<img src="/pc/images/pagedb.png">
			<table class="apply" id="apply" cellpadding="0" cellspacing="0">
				<input type="hidden" name="gender" value="M">
				<%@ include file="/WEB-INF/views/common/utmParam.jsp"%>
				<tbody><tr>
					<td class="n">ㆍ성명</td><td style="width: 250px;"><input type="text" class="input" name="userName"></td>
					<td class="n">ㆍ전화번호</td><td><input type="text" class="input" name="userMobile"></td>
				</tr>
				<tr>
					<td class="n">ㆍ성별</td>
					<td>
					...
					<td class="n">ㆍ나이</td><td><input type="text" class="input" name="userAge"></td>
				</tr>
				<tr>
					<td class="n">ㆍ상담내용</td><td colspan="3"><input type="text" class="input" name="userConsult"></td>
				</tr>
				<!--<tr>
					<td class="n" colspan=2>ㆍ불편한 부위<span>(어깨,손,목,무릎,허리 기타)</span></td>
					<td colspan=2><input type="text" class="input" name="goal"/></td>
				</tr>-->
				<tr>
					<td colspan="4" class="agree1 n" align="center">
				...
				<tr>
					<td colspan="4"><center><a class="btn btn-save" t="#apply">상담 신청하기</a></center></td>
				</tr>
				</tbody>
			</table>
		</div>
	...
	<div class="footer">
		<div class="container">
			<b>종근당건강(주)</b> | 대표이사 : 김호곤 | 사업자등록번호 134-81-29992 | 건강기능식품광고심의필 : 190110362<br>
			통신판매업신고번호 : 제 2010-충남당진-0063호 <a href="http://www.ftc.go.kr/info/bizinfo/communicationList.jsp" target="_blank">[사업자정보확인]</a><br>
			건강기능식품판매업 : 제2005-74호 | 충청남도 당진시 송악읍 복운1길 30  | 고객콜센터 : 1644-8863 | 개인정보관리자 : 정문수<br>
